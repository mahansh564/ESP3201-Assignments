...
# !python mp1.py --method dfs map/single/openMaze.txt
# !python mp1.py --method bfs map/single/openMaze.txt
# !python mp1.py --method ucs map/single/openMaze.txt
# !python mp1.py --method ucs map/single/mediumMaze2.txt
# !python mp1.py --method astar map/single/openMaze.txt
# !python mp1.py --method astar map/single/mediumMaze2.txt
# !python mp1.py --method astar_corner map/corner/mediumCorners2.txt
# !python mp1.py --method astar_multi map/multi/openSearch.txt
# !python mp1.py --method astar_multi map/multi/mediumSearch2.txt
